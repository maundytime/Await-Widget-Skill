...
This policy applies to Await, its iOS widget extension, and the Await Widget Skill template.
...
You can delete widgets and their local stored data from within Await. Deleting the app also removes app-local data from the device, subject to iOS behavior for system-managed purchase records and external copies you exported.
