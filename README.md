...
This repository provides the public Await Widget Skill and widget template used to create AwaitJS widgets.
...
This is an installable skill and template repo for AI agents to create AwaitJS widgets.
